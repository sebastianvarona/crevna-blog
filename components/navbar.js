            ...
            <div className="container max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex h-full items-center sm:border-l border-border relative">
                        <button onClick={() => setLangDisplay(!langDisplay)} className={langDisplay ? "block ml-6 p-2 text-accent" : "block ml-6 p-2 text-primary hover:text-accent active:text-accent"}>
